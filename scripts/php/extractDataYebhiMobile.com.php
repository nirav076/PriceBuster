...
function extractDataYebhiMobile($data)
{
 ...
 //######################## Processing Per Product ########################
    ...
    {          
      ...
      array_push($itemNames, $doc->getElementById("p_$perProductId")->nodeValue);  //Get the Product Name refer to problems **
      
     
      array_push($images, $doc->getElementById("itemImg_$perProductId")->getAttribute("src")); // Get Images
      array_push($linksToProductPage,"http://www.yebhi.com".$doc->getElementById("anchor_$perProductId")->getAttribute("href")); // get the page link to individual Product
